package com.example.textscannerappocr;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_copy.setOnClickListener(v -> {
            String scanner_text = text_data.getText().toString();
            copyToClipBoard(scanner_text);
        });
    }
    ...
    private void copyToClipBoard(String text){
        ...
        ClipData clip = ClipData.newPlainText("Cliped data", text);
        clipBoard.setPrimaryClip(clip);
        Toast.makeText(MainActivity.this,"Copied to Clipboard", Toast.LENGTH_LONG);
    }
}